 ...
 * @created on 12 Sep 2018 at 10:27 AM
 */
internal class SlidingTabStrip @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) : LinearLayout(context, attrs) {
	...
	private var mCustomTabColorizer: SlidingTab.TabColorizer? = null
	...
	fun setCustomTabColorizer(customTabColorizer: SlidingTab.TabColorizer) {
	...
	override fun onDraw(canvas: Canvas) {
		...
		if (childCount > 0) {
			...
			mSelectedIndicatorPaint.color = Color.WHITE
	...
	private class SimpleTabColorizer : SlidingTab.TabColorizer {
	...
	companion object {
		...
		private val DEFAULT_SELECTED_INDICATOR_COLOR = Color.RED
