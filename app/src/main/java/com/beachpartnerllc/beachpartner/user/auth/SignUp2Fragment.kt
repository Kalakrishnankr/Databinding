...
class SignUp2Fragment : BaseFragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val email =
            RxTextView.afterTextChangeEvents(binding.emailET).skip(vm.signUp2SkipInitCount())
        val mobile =
            RxTextView.afterTextChangeEvents(binding.mobileET).skip(vm.signUp2SkipInitCount())
        val password =
            RxTextView.afterTextChangeEvents(binding.passwordET).skip(vm.signUp2SkipInitCount())
    ...
    fun onDobPicker() {
        ...
        dp.maxDate = Calendar.getInstance().timeInMillis -
