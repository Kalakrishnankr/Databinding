...
class MoreInfoFragment : BaseFragment() {
	...
	fun addTopFinish(topFinish: String? = null) {
		...
		val itemBinding: TopFinishesBinding = inflater.bind(R.layout.item_top_finishes, this.binding.topFinishesLL)
		itemBinding.handler = this
		itemBinding.vm = vm
		itemBinding.topFinishesAET.setText(topFinish)
		this.binding.topFinishesLL.addView(itemBinding.root)
