 ...
 * @created on 12 Sep 2018 at 10:25 AM
 */
class SlidingTab @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) : HorizontalScrollView(context, attrs, defStyle) {
	...
	/**
	 * Set the [ViewPager.OnPageChangeListener]. When using [SlidingTab] you are
	...
	protected fun createDefaultTabView(context: Context): TextView {
		...
		textView.setTextColor(resources.getColor(R.color.blue_78263588))
	...
	companion object {
		private val TITLE_OFFSET_DIPS = 14
